...
public class LightGrenade extends Item {
	...
	public void execute(TronObject object) throws IllegalStateException {
		if (this.state != LightGrenadeState.EXPLODED) {
			throw new IllegalStateException("One can only execute exploded lightgrenades");
		}
	...
	public enum LightGrenadeState {
		...
		/**
		 * the grenade is exploded. (It is immutable now)
		 */
		EXPLODED {
