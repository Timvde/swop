 ...
 * 
 * @param <E> The type of elements the user can chose
 */
public class UseArguments<E> {
	 ...
	 *        from the client
	 */
	public UseArguments(Set<E> choices, String question) {
	 ...
	 */
	public Set<E> getPossibleAnswers() {
		return new HashSet<E>(choices);
	}
	 ...
	 */
	public void setUserChoice(E choice) {
